...
# Run `pod lib lint ia_over_the_counter.podspec` to validate before publishing.
#
...
A new Flutter plugin project.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'ia_over_the_counter/Sources/ia_over_the_counter/**/*'
  s.dependency 'Flutter'
  s.dependency 'IAIntegrations', ios_appsdk_version
  s.dependency 'IAOverTheCounter', ios_appsdk_version
  s.platform = :ios, '15.0'
  ...
  # s.resource_bundles = {'ia_over_the_counter_privacy' => ['ia_over_the_counter/Sources/ia_over_the_counter/PrivacyInfo.xcprivacy']}
end
