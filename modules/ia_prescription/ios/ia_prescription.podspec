...
# Run `pod lib lint ia_prescription.podspec` to validate before publishing.
#
...
A new Flutter plugin project.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'ia_prescription/Sources/ia_prescription/**/*'
  s.dependency 'Flutter'
  s.dependency 'IAIntegrations', ios_appsdk_version
  s.dependency 'IAPrescription', ios_appsdk_version
  s.platform = :ios, '15.0'
  ...
  # s.resource_bundles = {'ia_prescription_privacy' => ['ia_prescription/Sources/ia_prescription/PrivacyInfo.xcprivacy']}
end
