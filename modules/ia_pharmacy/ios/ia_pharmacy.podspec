...
# Run `pod lib lint ia_pharmacy.podspec` to validate before publishing.
#
...
A new Flutter plugin project.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'ia_pharmacy/Sources/ia_pharmacy/**/*'
  s.dependency 'Flutter'
  s.dependency 'IAIntegrations', ios_appsdk_version
  s.dependency 'IAPharmacy', ios_appsdk_version
  s.platform = :ios, '15.0'
  ...
  # s.resource_bundles = {'ia_pharmacy_privacy' => ['ia_pharmacy/Sources/ia_pharmacy/PrivacyInfo.xcprivacy']}
end
