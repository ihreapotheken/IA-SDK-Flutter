...
# Run `pod lib lint ia_ordering.podspec` to validate before publishing.
#
...
A new Flutter plugin project.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'ia_ordering/Sources/ia_ordering/**/*'
  s.dependency 'Flutter'
  s.dependency 'IAIntegrations', ios_appsdk_version
  s.dependency 'IAOrdering', ios_appsdk_version
  s.platform = :ios, '15.0'
  ...
  # s.resource_bundles = {'ia_ordering_privacy' => ['ia_ordering/Sources/ia_ordering/PrivacyInfo.xcprivacy']}
end
